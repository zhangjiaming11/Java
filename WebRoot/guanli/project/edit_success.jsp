...
<table width="550"  border="0" cellspacing="1" cellpadding="1" class="tableBorder">
  ...
  <tr>
    <td bgcolor="E4EDF9" class="normalText">项目修改成功</td>
  </tr>
  <tr>
    <td align="center" bgcolor="E4EDF9"><a href="/Lab/guanli/project/project_list.jsp" class="normalText">&lt;&lt;返回查看其他项目信息</a></td>
  </tr>
</table>
</div>
</body>
